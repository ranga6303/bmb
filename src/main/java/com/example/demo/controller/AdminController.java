...
public class AdminController {
    ...
    public AdminController(AuthService authService, DeviceChangeService deviceChangeService, CurrentUserService currentUserService, UserRepository userRepository) {
